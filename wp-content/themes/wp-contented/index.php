		...
		<div class="front-wrapper">
			<div id="content">
				<div class="wrap">
					...
					<div id="slide-wrap" class="<?php echo esc_attr( $slider_class ); ?>">
						...
						<div class="cycle-slideshow" 
											...
											<div class="table-cell"> 
												<div class="slide-copy">
													<h2 class="slide-title">
														<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Read %s', 'wpcontented' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">
															<?php the_title(); ?>
														</a>
													</h2>
													<div class="date"><?php _e('By ','wpcontented'); ?><?php the_author_posts_link(); ?><?php printf( __( ' / <span>%2$s</span> / ', 'wpcontented' ), get_the_time('Y-m-j'), get_the_time(get_option('date_format'))); ?><?php $category_list = get_the_category_list( __( ', ', 'wpcontented' ) ); printf( __('%s', 'wpcontented'), $category_list); ?></div>
													<?php the_excerpt(); ?> 
												</div>
											</div>
										</div>
							...
							<div class="slidernav">
								<a id="sliderprev" href="#" title="<?php _e('Previous', 'wpcontented'); ?>"><span class="fa fa-angle-left"></span></a>
								<a id="slidernext" href="#" title="<?php _e('Next', 'wpcontented'); ?>"><span class="fa fa-angle-right"></span></a>
							</div>
					...
					<div class="sidebar-area">
						<?php if ( is_active_sidebar( 'sidebar2' )): ?>
								...
								<div class="no-widgets-here">
									<p><?php _e( 'This is a widget ready area. Add some and they will appear here.', 'wpcontented' );  ?></p>
								</div>
				...
				<div class="pagination">
					<?php next_posts_link( __('Older Entries','wpcontented'), $blogPosts->max_num_pages );?>
				</div>
				<?php wp_reset_postdata(); ?>
				<?php endif; ?>
			</div> <!-- content -->
